var vueModuleFrame = function(vue2) {
  ...
  function normalizeRecordProps(record) {
    ...
    if ("component" in record) {
      ...
      for (let name2 in record.components)
  ...
  function useLink(props) {
    ...
    function navigate(e = {}) {
      if (guardEvent(e)) {
        return router2[vue2.unref(props.replace) ? "replace" : "push"](vue2.unref(props.to)).catch(noop);
      }
  ...
  const RouterViewImpl = /* @__PURE__ */ vue2.defineComponent({
    ...
    setup(props, { attrs, slots }) {
      ...
      const depth = vue2.inject(viewDepthKey, 0);
      const matchedRouteRef = vue2.computed(() => routeToDisplay.value.matched[depth]);
      vue2.provide(viewDepthKey, depth + 1);
  ...
  function createRouter(options) {
    ...
    function removeRoute(name2) {
      let recordMatcher = matcher.getRecordMatcher(name2);
      if (recordMatcher) {
  ...
  const _hoisted_2$1 = /* @__PURE__ */ vue2.createVNode("p", null, "\u8FD9\u91CC\u662F\u4E3B\u6846\u67B6\u6A21\u677F\u5DE5\u7A0B\u9875\u9762", -1);
  function _sfc_render$1(_ctx, _cache) {
    return vue2.openBlock(), vue2.createBlock("div", _hoisted_1$1, [
      _hoisted_2$1
    ]);
  }
  ...
  var _imports_0 = "data:image/svg+xml;base64,";
  var App_vue_vue_type_style_index_0_lang = "\nbody {\n  margin: 0;\n}\n.frame {\n  text-align: center;\n}\n.frame img {\n  width: 200px;\n}\n.frame a {\n  color: #49b883;\n}\nheader {\n  padding: 100px 0;\n  background: #fff;\n}\n";
  const _sfc_main = {};
  const _hoisted_1 = { class: "frame" };
  const _hoisted_2 = /* @__PURE__ */ vue2.createVNode("img", { src: _imports_0 }, null, -1);
  const _hoisted_3 = /* @__PURE__ */ vue2.createVNode("h1", null, "vue-module-loader", -1);
  const _hoisted_4 = /* @__PURE__ */ vue2.createVNode("h2", null, "\u5FAE\u524D\u7AEF\u67B6\u6784", -1);
  const _hoisted_5 = /* @__PURE__ */ vue2.createTextVNode("\u672C\u5730\u6A21\u5757");
  const _hoisted_6 = /* @__PURE__ */ vue2.createTextVNode(" | ");
  const _hoisted_7 = /* @__PURE__ */ vue2.createTextVNode("\u8FDC\u7A0B\u6A21\u5757");
  function _sfc_render(_ctx, _cache) {
    const _component_router_link = vue2.resolveComponent("router-link");
    const _component_router_view = vue2.resolveComponent("router-view");
    return vue2.openBlock(), vue2.createBlock("div", _hoisted_1, [
      vue2.createVNode("header", null, [
        _hoisted_2,
        _hoisted_3,
        _hoisted_4,
        vue2.createVNode(_component_router_link, { to: "/" }, {
        ...
        _hoisted_6,
        vue2.createVNode(_component_router_link, { to: "/module-page" }, {
          default: vue2.withCtx(() => [
            _hoisted_7
          ]),
          _: 1
  ...
  var module = {
    name,
    install(context) {
      const app = context.Vue.createApp(_sfc_main);
      context.app = app;
      app.use(router);
      app.mount("#app");
    }
...
//# sourceMappingURL=vue-module-frame.iife.js.map
